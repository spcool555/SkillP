				...
				<div class="col-md-6 col-lg-5">
					<div class="register-box bg-white box-shadow border-radius-10">
						<div class="wizard-content">
						 ...
						 <form class="tab-wizard2 wizard-circle wizard" action="/verify" id="myForm" modelAttribute="user"
								...
								<section>
									<div class="form-wrap max-width-600 mx-auto">
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<input type="text" id="email" name="email" path="email_id"  placeholder="Enter Email iD"
												 class="form-control" maxlength="255" autofocus="" required="required"/>
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-4 col-form-label">Registration Code*</label>
											<div class="col-sm-8">
												<input type="text" id="reg_code" name="otp"  class="form-control"
												maxlength="255" required="required" placeholder="Enter Registration Code">
											</div>
										</div>
										<div class="alert alert-danger alert-dismissable fade in errorBox"
										id="errorBox1" style="display: none;">
								...
								<section>
									<div class="form-wrap max-width-600 mx-auto">
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<input type="password" id="pass" name="Enter Password" class="form-control"
										...
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<form:input type="password" path="psswrd_data" id="cPass" class="form-control" placeholder="Enter Confirm Password" maxlength="255"
											required="required"/>
											</div>
										</div>
