					...
					class="form-horizontal tab-wizard2 wizard-circle wizard" method="post">
								...
								<section>
									...
									<div class="form-group row align-items-center">
										...
										id="street_number"  maxlength="100" title="${MessageConstants.address_tooltip}"/>
											</div>
										</div>
										<div class="form-group row align-items-center">
										...
										placeholder="City" id="locality"  maxlength="25" />
											</div>
										</div>
										<div class="form-group row align-items-center">
								...
								<section>
									...
									<div class="form-group row align-items-center">
											...
											<div class="col-sm-8">
												<input name="country" class="form-control" placeholder="Country" id="country"
										 maxlength="25" title="${MessageConstants.address_tooltip}"/>
											</div>
										</div>
										<div class="form-group row align-items-center">
											...
											<div class="col-sm-8">
												<input name="pincode" class="form-control" pattern="[0-9]{6}" title="${MessageConstants.address_tooltip}"
									...
									<small id="contact_error" style="color: red;"></small>
										...
										<div class="form-group row align-items-center">
											...
											<div class="col-sm-8">
												<input name="contact_2" id="contact" class="form-control contact" />
								...
								<section>
									<div class="form-wrap max-width-600 mx-auto">
										...
										<div class="form-group row align-items-center">
											...
											<div class="col-sm-8">
												<input name="ucontact" id="contact" class="form-control contact" />
								...
								<section>
									...
									<div class="form-group row align-items-center">
										...
										<div class="col-sm-10">
											<input type="file" name="logo" id="upload-photo" accept="image/*" class="form-control-file form-control height-auto">
