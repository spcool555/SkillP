...
<body class="login-page">
	...
	<div class="register-page-wrap d-flex align-items-center flex-wrap justify-content-center">
		<div class="container">
			...
			<form:form modelAttribute="company" id="my_form" action="${addAction}" enctype="multipart/form-data"
				method="post" class="form-horizontal tab-wizard2 wizard-circle wizard">
								...
								<section>
									<div class="form-wrap max-width-600 mx-auto">
										<div class="form-group row align-items-center">
											...
											<div class="col-sm-8">
												<form:input path="company_name" id="comp_name" class="form-control firstCapital" onchange="checkExists(this)"
									...
									<small id="namelabel" style="color: red;"></small>
										...
										<div class="form-group row align-items-center">
											...
											<div class="col-sm-8">
												<form:input path="registration_no" class="form-control" required="true"
										...
										<div class="form-group row align-items-center">
											...
											<div class="col-sm-8">
												<form:input path="estd_date" class="form-control date_OB date-picker" id="datepicker"
										...
										<div class="form-group row align-items-center">
											...
											<div class="col-sm-8">
												<form:input path="web_url" placeholder="Company Website" class="form-control" required="true"
										maxlength="30" pattern="[a-zA-Z0-9_\-]+(\.[a-zA-Z0-9_\-]+){2,3}$" title="www.example.com"/>
											</div>
										</div>
										...
										<div class="form-group row align-items-center">
											...
											<div class="col-sm-8">
												<form:textarea path="about" class="form-control" rows="3" placeholder="About company..." required="true" maxlength="750" style="height: auto !important;" />
											</div>
								...
								<section>
									...
									<div class="form-group row align-items-center">
											...
											<div class="col-sm-8">
												<form:input path="email_id" id="mail_id" class="form-control" required="true" maxlength="50"
										pattern="[a-z0-9._%+-]+@[a-z0-9.-]+(\.[a-z]+){1,2}$" onchange="checkExists(this)"
										onblur="checkExists(this)" placeholder="Company Email-Id"/>
									<small id="maillabel" style="color: red;"></small>
										...
										<div class="form-group row align-items-center">
											...
											<div class="col-sm-8">
												<input id="address-autocomplete" placeholder="Enter your City" onFocus="geolocate()" type="text" class="form-control" required="true"></input>
											</div>
										</div>
										<div class="form-group row align-items-center">
											<label class="col-sm-4 col-form-label">Address (Line-1)<span style="color: red">*</span></label>
											<div class="col-sm-8">
												<form:input path="address.line_1" class="form-control" placeholder="Address line 1 "
										id="street_number" required="true" disabled="false" maxlength="100" title="Please select the city first in the given area."/>
											</div>
										</div>
										<div class="form-group row align-items-center">
											<label class="col-sm-4 col-form-label">Address (Line-2)<span style="color: red">*</span></label>
											<div class="col-sm-8">
												<form:input path="address.line_2" class="form-control" title="Please select the city first in the given area."
										id="route" placeholder="Address line 2" disabled="false" maxlength="100" />
											</div>
										</div>
										<div class="form-group row align-items-center">
											<label class="col-sm-4 col-form-label">City<span style="color: red">*</span></label>
											<div class="col-sm-8">
												<form:input path="address.city" class="form-control" title="Please select the city first in the given area."
								...
								<section>
									...
									<div class="form-group row align-items-center">
											...
											<div class="col-sm-8">
												<form:input path="address.state" class="form-control" title="Please select the city first in the given area."
										placeholder="State" id="administrative_area_level_1" readonly="false" required="true" maxlength="25" />
											</div>
										</div>
										<div class="form-group row align-items-center">
											<label class="col-sm-4 col-form-label">Country<span style="color: red">*</span></label>
											<div class="col-sm-8">
												<form:input path="address.country" class="form-control" title="Please select the city first in the given area."
										placeholder="Country" id="country" readonly="false" required="true" maxlength="25" />
											</div>
										</div>
										<div class="form-group row align-items-center">
										<label class="col-sm-4 col-form-label">Pincode<span style="color: red">*</span></label>
											<div class="col-sm-8">
												<form:input path="address.pincode" class="form-control" pattern="[0-9]{6}" title="Please select the city first in the given area."
									...
									<div class="form-group row align-items-center">
											...
											<div class="col-sm-8">
												<form:input path="contact_1" id="contact" class="form-control contact" pattern="\d*"
									...
									<small id="contact_error" style="color: red;"></small>
										...
										<div class="form-group row align-items-center">
											...
											<div class="col-sm-8">
												<form:input path="contact_2" id="contact2" class="form-control contact" pattern="\d*"
								...
								<section>
									<div class="form-wrap max-width-600 mx-auto">
										...
										placeholder="Enter Email-Id" onchange="checkExists(this)" onblur="checkExists(this)">
